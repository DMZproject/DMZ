...
public class NumericTransform extends Filter implements UnsupervisedFilter,
  ...
  public String globalInfo() {
    ...
    return "임의의 자바 함수를 이용해 수치 속성을 변환시킨다.";
  }
  ...
  public String classNameTipText() {
    return "변환에 사용 된 함수를 포함하는 클래스의 이름.";
  }
  ...
  public String invertSelectionTipText() {
    return "True 이면, 선택된 속성을 제외하고 나머지 속성을 선택.";
  }
  ...
  public String attributeIndicesTipText() {
    return "적용할 속성의 범위를 지정합니다. "
      + "처음 세 개의 속성에 대해 1-3과 같이 표현하거나 1,2,3,5,9,10,11,12 속성에 대해 "
      + "first-3,5,9-last로 표현해 여러 속성의 범위를 지정할 수 있습니다. "
      + "예시 : \"first-3,5,6-10,last\".";
  }
