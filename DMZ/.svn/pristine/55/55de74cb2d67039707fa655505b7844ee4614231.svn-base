...
public class Discretize extends Filter implements SupervisedFilter,
  ...
  public String globalInfo() {
    ...
    return "새로운 속성과 속성 값을 추가한다. 이 값들은 누락된 속성 값으로 마크된다."
      + " 제네릭 객체 편집기를 이용해 속성의 이름을 지정하는데, 여기서 속성 리스트에"
      + " 속성과 함께 속성이 가질 수 있는값들이 나타난다. \n\n"
  ...
  public String useBinNumbersTipText() {
    return "사용 빈 번호 (예 BXofY)보다는 이산화 속성의 범위를 사용합니다.";
  }
