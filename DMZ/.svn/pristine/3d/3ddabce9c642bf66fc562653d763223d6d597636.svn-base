...
public class ListSelectorDialog
  ...
  protected JButton m_SelectBut = new JButton("선택");

  /** Click to cancel the property selection */
  protected JButton m_CancelBut = new JButton("취소");

  /** Click to enter a regex pattern for selection */
  protected JButton m_PatternBut = new JButton("패턴");
  ...
  public ListSelectorDialog(Frame parentFrame, JList userList) {
    ...
    super(parentFrame, "속성 선택", ModalityType.DOCUMENT_MODAL);
    m_List = userList;
