...
public class Copy extends Filter implements UnsupervisedFilter,
  ...
  public String globalInfo() {
    ...
    return "데이터에 존재하는 속성들을 복사한다. "
      + " 처음 세 개의 속성에 대해 1,2,3,5,9,10,11,12 속성에 대해 first-3, 5, 9-last로"
      + " 표현해 여러 속성을 한꺼번에 복사할 수도 있다. 선택 상태를 전환시킬 수도 있다. ";
  }
  ...
  public String invertSelectionTipText() {
    return "TRUE선택시, 선택한 속성을 제외하고 나머지 값들을 복사해줌 즉, (Invert) 기능수행 ";
  }
  ...
  public String attributeIndicesTipText() {
    return "필터를 적용할 속성의 범위를 지정 (' , ' 로 구분함) ";
  }
