...
public class RemoveType extends Filter implements UnsupervisedFilter,
  ...
  public static final Tag[] TAGS_ATTRIBUTETYPE = {
    new Tag(Attribute.NOMINAL, "명목속성 삭제"),
    new Tag(Attribute.NUMERIC, "수치속성 삭제"),
    new Tag(Attribute.STRING, "문자속성 삭제"),
    new Tag(Attribute.DATE, "날짜속성 삭제"),
    new Tag(Attribute.RELATIONAL, "연관속성 삭제") };
  ...
  public String globalInfo() {
    ...
    return "주어진 타입(명목, 수치, 문자열, 날짜 등)의 속성을 제거한다.";
  }
  ...
  public String invertSelectionTipText() {
    ...
    return "삭제 여부를 결정합니다."
      + "true로 설정된 경우에만 지정된 속성이 유지됩니다"
      + "false로 설정하면, 지정된 속성이 삭제됩니다.";
  }
