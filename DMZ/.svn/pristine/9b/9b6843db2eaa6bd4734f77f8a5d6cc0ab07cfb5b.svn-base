...
public class AssociationsPanel extends JPanel implements
  ...
  protected JButton m_StartBut = new JButton("Edit");

  /** Click to stop a running associator */
  protected JButton m_StopBut = new JButton("취소");
  ...
  public AssociationsPanel() {
    ...
    m_History.setBorder(BorderFactory
      .createTitledBorder("연관(Associator) 결과리스트"));
    ...
    p3.setBorder(BorderFactory.createTitledBorder("연관(Associator) 결과 출력"));
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
  ...
  public GenericObjectEditor getAssociatorEditor(){
	  return this.m_AssociatorEditor;
  }
  @Override
  ...
  protected void historyRightClickPopup(String name, int x, int y) {
    ...
    JMenuItem saveOutput = new JMenuItem("결과리스트 저장하기");
    if (selectedName != null) {
    ...
    JMenuItem deleteOutput = new JMenuItem("결과리스트 지우기");
    if (selectedName != null) {
