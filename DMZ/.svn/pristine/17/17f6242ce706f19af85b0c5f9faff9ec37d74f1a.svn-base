...
public class AttributeSummaryPanel extends JPanel {
  ...
  public AttributeSummaryPanel() {
    ...
    JLabel lab = new JLabel("속성명:", SwingConstants.RIGHT);
    ...
    lab = new JLabel("타입:", SwingConstants.RIGHT);
    lab.setBorder(BorderFactory.createEmptyBorder(0, 10, 0, 0));
    gbC = new GridBagConstraints();
    gbC.anchor = GridBagConstraints.EAST;
    gbC.fill = GridBagConstraints.HORIZONTAL;
    ...
    lab = new JLabel("오류율:", SwingConstants.RIGHT);
  ...
  protected void setHeader(int index) {
    ...
    default:
      ...
      */
    case Attribute.NOMINAL:
    m_AttributeTypeLab.setText("명목형 (Nominal)");
    break;
  case Attribute.NUMERIC:
    m_AttributeTypeLab.setText("수치형 (Numeric)");
    break;
  case Attribute.STRING:
    m_AttributeTypeLab.setText("문자형 (String)");
    break;
  case Attribute.DATE:
    m_AttributeTypeLab.setText("날짜형 (Date)");
    break;
  case Attribute.RELATIONAL:
    m_AttributeTypeLab.setText("관계형 (Relational)");
    break;
  default:
    m_AttributeTypeLab.setText("Unknown");
    break;
