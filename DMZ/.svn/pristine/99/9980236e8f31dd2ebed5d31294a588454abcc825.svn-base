 ...
 */
public class ResultHistoryPanel extends JPanel implements Cloneable{
  ...
  public Hashtable<String, Object> getObj(){
	  return m_Objs;
  }
  
  public void setHistory(DefaultListModel model,Hashtable<String, StringBuffer> result, Hashtable<String, Object> obj){
	  m_Model = model;
	  m_Results = result;
	  m_Objs = obj;
 }
  ...
  public Hashtable<String, StringBuffer> getResult()
  {
	  return m_Results;
  }

  public Hashtable<String, JTextArea> getFrameOutput(){
	  return m_FramedOutput;
  }
  /**
  ...
  public static void main(String[] args) {
    ...
    try {
      final javax.swing.JFrame jf = new javax.swing.JFrame("DMZ: Classifier");
      jf.getContentPane().setLayout(new BorderLayout());
