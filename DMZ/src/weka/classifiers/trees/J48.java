...
public class J48 extends AbstractClassifier implements OptionHandler, Drawable,
  ...
  public String seedTipText() {
    return "감소된 에러에 가지치기를 사용하는 경우 데이터 랜덤화에 사용되는 시드";
  }
  ...
  public String useLaplaceTipText() {
    return "리프들의 갯수는 라플라스를 기반으로 다듬어집니다.";
  }
  ...
  public String useMDLcorrectionTipText() {
    return "숫자 속성에 대한 분할을 찾는 경우 MDL 보정이 사용됩니다.";
  }
  ...
  public String collapseTreeTipText() {
    return "훈련 오류로 줄어들지 않은 부분이 제거됩니다.";
  }
  ...
  public String confidenceFactorTipText() {
    return "신뢰 계수는 가지치기에 사용됩니다. (작은 값이 더 많은 가지치기를 합니다.).";
  }
  ...
  public String reducedErrorPruningTipText() {
    return "감소 된 오류를 가지치기 대신에 C.4.5방식의 가지치기가 사용됩니다.";
  }
  ...
  public String numFoldsTipText() {
    return "감소된 에러 가지치기에 사용되는 데이터의 양을 결정한다."
      + "한 포드는 트리의 성장을 위해, 나머지는 가지치기를 위해 사용";
  }
  ...
  public String binarySplitsTipText() {
    return "트리를 구축 할 때 명목 속성에 대해 이진 분할을 사용할지 여부를 지정합니다.";
  }
  ...
  public String subtreeRaisingTipText() {
    return "가지치기 할 때 하위 트리 올림 여부를 지정합니다.";
  }
  ...
  public String saveInstanceDataTipText() {
    return "시각화를 위한 훈련 데이터를 저장할지 여부를 지정합니다.";
  }
  ...
  public String doNotMakeSplitPointActualValueTipText() {
    return "true의 경우, 분리 점은 실제 데이터 값에 이전 되지 않습니다."
      + "이것은 숫자 속성으로 이루어진 대형 데이터 셋에 대해서 상당한 속도 향상 효과를 얻을 수 있습니다.";
  }
