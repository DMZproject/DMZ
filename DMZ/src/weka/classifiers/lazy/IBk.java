...
public class IBk 
  ...
  public static final Tag [] TAGS_WEIGHTING = {
    new Tag(WEIGHT_NONE, "거리가중치 사용하지 않음"),
    new Tag(WEIGHT_INVERSE, "가중치 by 1/거리"),
    new Tag(WEIGHT_SIMILARITY, "가중치 by 1-거리")
  };
  ...
  public String windowSizeTipText() {
   ...
   //   "to the number of training instances.";
	  ...
	  return "인스턴스들의 최대 수 .새로운 인스턴스에의해 이전 인스턴스는 제거된다.값 0은 훈련 인스턴스의 제한 없음을 의미. ";
  }
  ...
  public String crossValidateTipText() {
   ...
   // return "Whether hold-one-out cross-validation will be used to " +
    ...
    //		"the KNN parameter.";
	  return "교차 검증 결과를  KNN 파라미터로 지정된 하나의 최적 값과 K 값을 선택하는데 사용될 것인지 여부";
  }
...
//    return "The nearest neighbour search algorithm to use " +
 //   	   "(Default: weka.core.neighboursearch.LinearNNSearch).";
	  return "사용할 근접 알고리즘을 선택(디폴트값 : LinearNNSearch 알고리즘) ";
  }
