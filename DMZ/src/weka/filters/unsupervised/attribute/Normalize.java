...
public class Normalize extends PotentialClassIgnorer implements
  ...
  public String globalInfo() {
    return "데이터에 존재하는 모든 수치 속성을 [0,1] 구간 안에 들어오게 스케일을 변경해서 "
      + "분포시킨다.이렇게 정규화된 값에 크기 변환을 더 적용할 수 있으며, 사용자가 정의한  "
      + "상수만큼 변환 할 수 있다. ";
  }
