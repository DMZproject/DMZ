...
public class Add extends Filter implements UnsupervisedFilter,
  ...
  public static final Tag[] TAGS_TYPE = {
    new Tag(Attribute.NUMERIC, "NUM", "수치형 속성"),
    new Tag(Attribute.NOMINAL, "NOM", "명목형 속성"),
    new Tag(Attribute.STRING, "STR", "문자형 속성"),
    new Tag(Attribute.DATE, "DAT", "날짜형 속성") };
  ...
  public String globalInfo() {
    ...
    return "새로운 속성과 속성 값을 추가한다. 이 값들은 누락된 속성 값으로"
      + " 마크된다.";
  }
...
//      + "(first and last are valid indices).";
	    return "새로운 속성을 넣을 위치(시작 인덱스는 1번 ). "
	      + "(first 또 last 로 넣어도 됨).";
  }
  ...
  public String nominalLabelsTipText() {
    return "명목속성에 삽입할 인스턴스들을 삽입(' , '로 구분가능하며 오직 명목속성에서만 사용가능)";
  }
  ...
  public String dateFormatTipText() {
    return "날짜 타입 포맷 지정 (see ISO-8601).";
  }
