...
public class AddExpression extends Filter implements UnsupervisedFilter,
  ...
  public String globalInfo() {
    return "기존 속성에 특정 수학적 기능을 적용함으로써 새로운 속성을 생성해준다. "
      + "즉, 수학적 함수를 수치 속성에 적용해 새로운 속성을 만들어 낸다. "
      + "수식에는 속성 참조자와 상수들이 포함될 수 있다. 즉, 수학 연산자인 +,-,*,^ 그리고 "
      + "log, exp, abs, sqrt, floor, cell, right등의 함수, 그리고() 등의 기호가"
      + "포함될 수 있다. 접두어 a를 통해 속성을 지정한다. \n"
      + "예시 표현: a1^2*a5/log(a7*4.0).";
  }
  ...
  public String expressionTipText() {
    return "적용할 수학 식을 설정합니다. Eg. a1^2*a5/log(a7*4.0)";
  }
