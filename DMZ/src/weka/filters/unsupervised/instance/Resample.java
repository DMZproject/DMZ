...
OptionHandler {
  ...
  public String globalInfo() {
    return "데이터 집합의 임의의 하위 표본을 도출해 대체 데이터로 표본 추출한다.즉 대체를 적용하거나 적용하지 않고 표본을 추출함으로써 무작위 표본추출을 수행한다. ";
  }
  ...
  public String sampleSizePercentTipText() {
    return "오리지널 데이터 대비 샘플링 할 하위 샘플의 데이터를 %로 지정";
  }
  ...
  public String invertSelectionTipText() {
     return "선택한것을 제외함 즉 인스턴스는 교체없이 그려짐 ";
  }
