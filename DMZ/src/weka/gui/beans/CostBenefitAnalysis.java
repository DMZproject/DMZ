...
public class CostBenefitAnalysis extends JPanel implements BeanCommon,
  ...
  protected static class AnalysisPanel extends JPanel {
    ...
    protected JRadioButton m_percPop = new JRadioButton("집단(%) ");
    protected JRadioButton m_percOfTarget = new JRadioButton(
      "타겟(%)");
    protected JRadioButton m_threshold = new JRadioButton("Threshold 점수");
    ...
    protected JLabel m_conf_predictedA = new JLabel("예측 (a)",
      SwingConstants.RIGHT);
    protected JLabel m_conf_predictedB = new JLabel("예측 (b)",
      SwingConstants.RIGHT);
    protected JLabel m_conf_actualA = new JLabel(" 실제 (a):");
    protected JLabel m_conf_actualB = new JLabel(" 실제 (b):");
    ...
    // Cost matrix stuff
    protected JLabel m_cost_predictedA = new JLabel("예측 (a)",
      SwingConstants.RIGHT);
    protected JLabel m_cost_predictedB = new JLabel("예측 (b)",
      SwingConstants.RIGHT);
    protected JLabel m_cost_actualA = new JLabel(" 실제 (a)");
    protected JLabel m_cost_actualB = new JLabel(" 실제 (b)");
    ...
    protected JButton m_maximizeCB = new JButton("최대 비용 /이익");
    protected JButton m_minimizeCB = new JButton("최소 비용/이익");
    protected JRadioButton m_costR = new JRadioButton("비용");
    protected JRadioButton m_benefitR = new JRadioButton("이익");
    protected JLabel m_costBenefitL = new JLabel("비용: ", SwingConstants.RIGHT);
    ...
    public AnalysisPanel() {
      ...
      threshInfoPanel
        .add(new JLabel("집단(%): ", SwingConstants.RIGHT));
      threshInfoPanel.add(m_percPopLab);
      threshInfoPanel.add(new JLabel("타겟(%)t: ", SwingConstants.RIGHT));
      threshInfoPanel.add(m_percOfTargetLab);
      threshInfoPanel
        .add(new JLabel("Threshold 점수: ", SwingConstants.RIGHT));
      ...
      accHolder.add(new JLabel("분류(Classification) 정확도: "));
      ...
      costPanel.setBorder(BorderFactory.createTitledBorder("비용 행렬"));
      ...
      tempP.add(new JLabel("랜덤: ", SwingConstants.RIGHT));
      tempP.add(m_randomV);
      tempP.add(new JLabel("이익: ", SwingConstants.RIGHT));
      tempP.add(m_gainV);
    ...
    private void setClassForConfusionMatrix(Attribute classAtt) {
      ...
      m_conf_actualA.setText(" 실제 (a): " + classAtt.value(0));
      ...
      m_conf_actualB.setText(" 실제 (b): " + negClasses);
