      ...
      if (columnIndex == 0) {
        ...
        if (m_Data != null) {
          if ((columnIndex - 1 < m_Data.numAttributes())) {
            ...
            case Attribute.DATE:
              result += "<br><font size=\"-2\">날짜형(Data)</font>";
              break;
            case Attribute.NOMINAL:
              result += "<br><font size=\"-2\">명목형(Nominal)</font>";
              break;
            case Attribute.STRING:
              result += "<br><font size=\"-2\">문자형(String)</font>";
              break;
            case Attribute.NUMERIC:
              result += "<br><font size=\"-2\">수치형(Numeric)</font>";
              break;
            case Attribute.RELATIONAL:
              result += "<br><font size=\"-2\">관계형(Relational)</font>";
              break;
            default:
