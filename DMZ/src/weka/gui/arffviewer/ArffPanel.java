...
public class ArffPanel extends JPanel implements ActionListener,
  ...
  protected void createPanel() {
    ...
    menuItemMean = new JMenuItem("평균 계산");
    menuItemMean.addActionListener(this);
    menuItemSetAllValues = new JMenuItem("다음으로 모든 값 변경");
    menuItemSetAllValues.addActionListener(this);
    menuItemSetMissingValues = new JMenuItem("다음으로 결측치값 변경");
    menuItemSetMissingValues.addActionListener(this);
    menuItemReplaceValues = new JMenuItem("다음으로 값 변경");
    menuItemReplaceValues.addActionListener(this);
    menuItemRenameAttribute = new JMenuItem("속성명 변경");
    menuItemRenameAttribute.addActionListener(this);
    menuItemAttributeAsClass = new JMenuItem("클래스 속성");
    menuItemAttributeAsClass.addActionListener(this);
    menuItemDeleteAttribute = new JMenuItem("선택된 속성 삭제");
    menuItemDeleteAttribute.addActionListener(this);
    menuItemDeleteAttributes = new JMenuItem("속성 선택삭제");
    menuItemDeleteAttributes.addActionListener(this);
    menuItemSortInstances = new JMenuItem("데이터 정렬(오름차순)");
    menuItemSortInstances.addActionListener(this);
    menuItemOptimalColWidth = new JMenuItem("선택된 속성의 너비 최적화");
    menuItemOptimalColWidth.addActionListener(this);
    menuItemOptimalColWidths = new JMenuItem("모든 속성의 너비 최적화");
    menuItemOptimalColWidths.addActionListener(this);
    // row popup
    
    
    //menuItemUndo = new JMenuItem("Undo");
    menuItemUndo = new JMenuItem("되돌리기");
    menuItemUndo.addActionListener(this);
    //menuItemCopy = new JMenuItem("Copy");
    menuItemCopy = new JMenuItem("복사");
    menuItemCopy.addActionListener(this);
    //menuItemSearch = new JMenuItem("Search...");
    menuItemSearch = new JMenuItem("검색");
    menuItemSearch.addActionListener(this);
    menuItemClearSearch = new JMenuItem("검색 해제");
    menuItemClearSearch.addActionListener(this);
    menuItemDeleteSelectedInstance = new JMenuItem("선택된 인스턴스 삭제");
    ...
    m_TableArff.setToolTipText("마우스 우클릭 (or 마우스 좌클릭 +alt) for context menu");
    m_TableArff.getTableHeader().addMouseListener(this);
    m_TableArff
      .getTableHeader()
      .setToolTipText(
        "<html><b>Sort view:</b> 마우스 좌클릭 = 오름차순 / Shift + 마우스 좌클릭 = 내림차순<br><b>Menu:</b> 마우스 우클릭 (or 마우스 좌클릭 +alt)</html>");
  ...
  private void createName() {
    ...
    if ((model != null) && (model.getInstances() != null)) {
      m_LabelName.setText("데이터: " + model.getInstances().relationName());
    } else {
      m_LabelName.setText("");
    }
  }
  ...
  private void calcMean() {
    ...
    // show result
    ComponentHelper.showMessageBox(getParent(), "속성 평균",
      "속성 '" + m_TableArff.getPlainColumnName(m_CurrentCol)
  ...
  public void deleteAttribute() {
    ...
    if (ComponentHelper.showMessageBox(
      ...
      "주의",
      "속성 '"
        + model.getAttributeAt(m_CurrentCol).name() + "'을 정말로 삭제하시겠습니까?",
  ...
  public void deleteAttributes() {
    ...
    // really?
    if (ComponentHelper.showMessageBox(getParent(), "주의",
      "선택한 " + atts.length + "개의 속성을 정말로 삭제하시겠습니까 ?",
      JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE) != JOptionPane.YES_OPTION) {
      return;
    }
  ...
  public void renameAttribute() {
    ...
    newName = ComponentHelper.showInputBox(getParent(), "속성명 변경",
      "새로운 속성명을 입력하세요", model.getAttributeAt(m_CurrentCol).name());
    if (newName == null) {
      return;
    }
  ...
  public void search() {
    ...
    // display dialog
    searchString = ComponentHelper.showInputBox(getParent(), "검색",
      "검색할 내용을 입력하세요", m_LastSearch);
