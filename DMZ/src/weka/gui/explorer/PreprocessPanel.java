...
public class PreprocessPanel extends JPanel 
  ...
  protected JButton m_OpenFileBut = new JButton("파일 열기");

  /** Click to load base instances from a URL */
  protected JButton m_OpenURLBut = new JButton("URL 열기");
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
  public void startApply(){
	  applyFilter((Filter) getFilterEditor().getValue());
  }
  public GenericObjectEditor getFilterEditor(){
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
	    ...
	    JOptionPane.showMessageDialog(PreprocessPanel.this,
					  ...
					  "Apply Filter",
					  JOptionPane.ERROR_MESSAGE);
	    m_Log.logMessage("인스턴스 적용시 문제가 생겼습니다.: " + ex.getMessage());
	    m_Log.statusMessage("인스턴스 적용시 문제가 생겼습니다.:");
	  }
	  m_IOThread = null;
	  la.getInputData().setInstances(m_Instances);
  ...
  public static void main(String [] args) {
    ...
    try {
      final JFrame jf = new JFrame("DMZ: Preprocess");
