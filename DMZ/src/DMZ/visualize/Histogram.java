...
public class Histogram {
	...
	public Histogram() {
		...
		attStuffHolderPanel.setBackground(Color.WHITE);
		...
		attInfo.setBackground(Color.WHITE);
		attInfo.add(attStuffHolderPanel, BorderLayout.CENTER);

		JPanel attVis = new JPanel();
		attSummaryPanel.setBackground(Color.white);
		attVis.setBackground(Color.WHITE);
